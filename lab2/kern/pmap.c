...
/* Overview:
 *   Allocates a physical page from free memory, and fill this page with zero.
 *
 * Post-Condition:
...
/* Overview:
 *   Map the physical page 'pp' at virtual address 'va'. The permissions (the low 12 bits) of the
