 ...
 *   Return -E_INVAL: 'srcva' or 'dstva' is illegal.
 ...
 *
 * Post-Condition:
 *   Return the child's envid on success, and
 *   - The new env's 'env_tf' is copied from 'curenv', except for $v0 set to 0 to indicate the
 ...
 * Post-Condition:
 *   Returns 0 on success, < 0 on error.
 *   Return -E_INVAL if 'status' is neither 'ENV_RUNNABLE' nor 'ENV_NOT_RUNNABLE'.
 *
 * Hint:
 ...
 * Post-Condition:
 * 	Returns 0 on success, < 0 on error.
 * 	Return -E_INVAL if the environment cannot be manipulated or 'tf' is invalid.
 */
...
int sys_ipc_recv(u_int dstva) {
	...
	/* Hint: This syscall should set the 'curenv''s status to 'ENV_NOT_RUNNABLE'. */

	/* Exercise 4.8: Your code here. (1/7) */

	/* Exercise 4.8: Your code here. (2/7) */
...
int sys_ipc_try_send(u_int envid, u_int value, u_int srcva, u_int perm) {
	...
	/* Exercise 4.8: Your code here. (3/7) */

	/* Exercise 4.8: Your code here. (4/7) */

	/* Exercise 4.8: Your code here. (5/7) */
	...
	/* Exercise 4.8: Your code here. (6/7) */

	if (srcva != 0) {
		/* Exercise 4.8: Your code here. (7/7) */
...
void do_syscall(struct Trapframe *tf) {
	...
	/* Step 4: Last 2 args are stored at [$sp + 16 bytes], [$sp + 20 bytes] */
