...
#define vpt ((Pte *)UVPT)
#define vpd ((Pde *)(UVPT + (PDX(UVPT) << PGSHIFT)))
#define envs ((struct Env *)UENVS)
#define pages ((struct Page *)UPAGES)
...
int syscall_ipc_try_send(u_int envid, u_int value, void *srcva, u_int perm);
